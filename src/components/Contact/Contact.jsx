      ...
      <motion.div variants={variants2} initial="initial" whileInView="animate" className="desktopForm right w-[50%] h-full p-[10px]">
        ...
        >
          <div className="w-[90%] h-[90%] py-[5vh] border-[1px] rounded-2xl border-cyan-400 flex flex-col items-center justify-start gap-[5vh]">
            ...
            />
            <button
              className="border-[1px] font-bold cursor-pointer active:scale-95 border-cyan-300 px-[3.5vh] py-[1.5vh] text-xl text-cyan-300 rounded-full hover:bg-cyan-300 hover:text-black transform transition-all duration-500"
              type="submit"
            >
              Submit
            </button>
